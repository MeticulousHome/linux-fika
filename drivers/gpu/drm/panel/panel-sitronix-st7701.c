...
static const struct drm_display_mode hw_021p0z002_01_mode = {
	...
	// the timings are based on online sitronix engineer recommendations, not the datasheet
	.hdisplay   = 480,
	.hsync_start= 480 + 50,        // HFP
	.hsync_end  = 480 + 50 + 42,   // HFP + HPW
	.htotal     = 480 + 50 + 42 + 10, // HFP + HPW + HBP
...
static const struct st7701_panel_desc hw_021p0z002_01_desc = {
	...
	.nv_gamma = {
		...
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC251_MASK, 0x2E),
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_AJ_MASK, 0) |
		CFIELD_PREP(ST7701_CMD2_BK0_GAMCTRL_VC255_MASK, 0x1B)
	},
	.nlinv = 0,
